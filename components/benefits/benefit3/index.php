<?php
if (!wp_style_is('benefit3', 'enqueued')) {
    wp_enqueue_style('benefit3', get_template_directory_uri() . '/components/benefits/benefit3/style.css');
}
?>


<div class="benefits3 choose_section layout_padding">
         <div class="container">
